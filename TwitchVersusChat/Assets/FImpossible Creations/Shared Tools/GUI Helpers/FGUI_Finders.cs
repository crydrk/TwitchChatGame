...
namespace FIMSpace.FEditor
{
    public static class FGUI_Finders
    {
        ...
        /// <summary>
        /// Finding skinned mesh renderers and returning array of one with largest count of bones
        /// </summary>
        public static Transform[] GetBoneSearchArray(Transform root)
        {
